<div class="form content">
    <div id="form_grid">
        <div id="form_grid_tabla">
            <fieldset>
            <legend><?= __('Listado de reservas realizadas:') ?></legend>
            <table>
            <tr>
                ...
                <th><?= $this->Paginator->sort('id_user', 'Propietario') ?></th>
            ...
            <tr>
                ...
                <td><?php echo $this->Html->link('Ver detalles', ['controller' => 'Users', 'action' => 'view', $reservation->offer->vehicle->user_id], ['target' => '_blank']); ?></td>
                <td><?= $reservation->reqstate->name ?> </td>
                <?php if ($reservation->reqstate->name == 'Pendiente') { ?>
                    <td><?php echo $this->Html->link('Cancelar la reserva', ['controller' => 'Reservations', 'action' => 'cancel', $reservation->id], ['confirm' => '¿Estás seguro de que quieres cancelar la reserva?']); ?></td>
                <?php } ?>
            </tr>
            <?php endforeach; ?>
            </table>
